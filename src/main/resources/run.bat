...
set classpath=.
set classpath=%classpath%;.\goleek-desktop-2.0.jar
set classpath=%classpath%;.\lib\aopalliance-1.0.jar
set classpath=%classpath%;.\lib\aspectjweaver-1.8.4.jar
set classpath=%classpath%;.\lib\baseframework-client-1.0.jar
...
set classpath=%classpath%;.\lib\spring-web-4.0.9.RELEASE.jar
