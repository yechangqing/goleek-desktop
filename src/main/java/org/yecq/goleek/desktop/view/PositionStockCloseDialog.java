 ...
 * @author yecq
 */
class PositionStockCloseDialog extends JDialog {

    private Map obj;
    private PositionStockInfoBean pos;

    PositionStockCloseDialog(PositionStockInfoBean pos) {
