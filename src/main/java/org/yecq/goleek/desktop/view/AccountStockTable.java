 ...
 * @author yecq
 */
class AccountStockTable extends JTable {

    private AccountStockTableModel model;

    AccountStockTable() {
        this.model = new AccountStockTableModel();
    ...
    private void initListener() {
        ...
        this.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                final AccountStockInfoBean bean = model.getRowBean(row);
                if (e.isMetaDown()) {
