 ...
 * @author yecq
 */
class AccountFuturesDialog extends JDialog {

    private Map obj;

    AccountFuturesDialog() {
    ...
    private JPanel getCenterPanel() {
        ...
        AccountFuturesTable table = new AccountFuturesTable();
    ...
    private void initListener() {
        ...
        add.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                new AccountFuturesAddDialog().setVisible(true);
            }
        });
    }

    private void adjustSize() {
        AccountFuturesTable table = (AccountFuturesTable) obj.get("table");
        table.adjustWidth();
    }
